...
<body>
  ...
  <div class="divider">
    <h2> <span style="color: brown;">Videos de cuarto grado</span></h2>
  </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/WisKxClrWP4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/3cwzRNZf0w0" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/cUsxU2RfmI4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/fxEc4lM6eEM" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/Nc7_9VKbhu4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/Y0BGhl0jIyQ" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/sMMAwORMvsg" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/_yN2C_JwdZA" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/xR4btoE9IeA" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/WwwhWEupqS8" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/YzPmhC4-NW8" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/o3ghpdHWMwI" allowfullscreen></iframe>
        </div>
      </div>
  ...
  <div class="d-flex justify-content-between mt-3">
    <!-- Botón de regresar -->
    <a href="tg.php" class="btn btn-outline-primary">
      <i class="bi bi-arrow-left-circle"></i> Regresar
    </a>

    <!-- Botón de avanzar -->
    <a href="qg.php" class="btn btn-outline-success">
