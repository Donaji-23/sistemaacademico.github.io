  ...
  <main class="container py-5">
    ...
    <section class="mb-5">
      <div class="row align-items-center" id="acerca de">
        <div class="col-lg-6">
          <h2 class="fw-bold mb-4"> Danza - <span style="color: brown;">Educación Primaria</span></h2>
          <p class="lead" style="text-align:justify"></p>
          <p style="text-align: justify;">

            El área de Danza en la educación primaria tiene como objetivo desarrollar la expresión corporal,
            la coordinación motriz y la creatividad en los niños. A través del movimiento, los estudiantes
            aprenden a comunicarse, explorar la música y fortalecer habilidades físicas y emocionales.</p>
        </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 mb-4">
            <div class="embed-responsive embed-responsive-16by9">
              <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/hc77I3CPunc" allowfullscreen></iframe>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="embed-responsive embed-responsive-16by9">
              <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/r7eXaA7U8nY" allowfullscreen></iframe>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="embed-responsive embed-responsive-16by9">
              <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/_tTikl4sEnw" allowfullscreen></iframe>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="embed-responsive embed-responsive-16by9">
              <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/_1yoNZ8c8iI" allowfullscreen></iframe>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-between mt-3">
        <!-- Botón de regresar -->
        <a href="musica.php" class="btn btn-outline-primary">
          <i class="bi bi-arrow-left-circle"></i> Regresar
        </a>

        <!-- Botón de avanzar -->
        <a href="dibujo.php" class="btn btn-outline-success">
