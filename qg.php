...
<body>
  ...
  <div class="divider">
    <h2> <span style="color: brown;">Videos de quinto grado</span></h2>
  </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/hb3zN9R0gtw" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/RazDNRGZNoc" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/mJsppGdO-bI" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/5xN984-TaD4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/MpHjG8boZwI" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/NlUtioxJ3mo" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/4RGQhAvoGJ4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/6QE4Juca60g" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/KuAd4GNCaOA" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/I-RqiXdwuU8" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/8BeHufkVen8" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/ZjZYCeFJNGU" allowfullscreen></iframe>
        </div>
      </div>
  ...
  <div class="d-flex justify-content-between mt-3">
    <!-- Botón de regresar -->
    <a href="cg.php" class="btn btn-outline-primary">
      <i class="bi bi-arrow-left-circle"></i> Regresar
    </a>

    <!-- Botón de avanzar -->
    <a href="sextog.php" class="btn btn-outline-success">
