...
<body>
  ...
  <div class="divider">
    <h2> <span style="color: brown;">Videos de sexto grado</span></h2>
  </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/xULxkYnz-ak" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/sRH8K_eEBoM" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/HXZHL35F7fI" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/Gp29NK9YwNg" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/uvWbJ25X6KU" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/sDrSoJ2TFA4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/mLMulkDxJKg" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/tXcLh2HQOYQ" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/M_DixVADeNs" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/m_hMIYJQbFo" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/F-4cANRS74A" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/6PM8LbgiOPQ" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/ekHa1o3u-Ko" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/yj7mYwa7c-4" allowfullscreen></iframe>
        </div>
      </div>
  ...
  <div class="d-flex justify-content-between mt-3">
    <!-- Botón de regresar -->
    <a href="qg.php" class="btn btn-outline-primary">
      <i class="bi bi-arrow-left-circle"></i> Regresar
    </a>

    <!-- Botón de avanzar -->
    <a href="tingles.php" class="btn btn-outline-success">
