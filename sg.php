...
<body>
  ...
  <div class="divider">
    <h2> <span style="color: brown;">Videos de segundo grado</span></h2>
  </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/vW-8_gMwrjs" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/DW8uuVZoYNE" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/JWstLFgzxZM" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/GWElwZGZaLo" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/GXS3jT4Oqp4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/wSbCJwqINyo" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/nuseNHGVoic" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/D0RgdfHXFKE" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/eXmz3ibN0Mk" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/SviNO1z8rZ4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/1hrcA6gIpmQ" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/7sYF4E6Zpz4" allowfullscreen></iframe>
        </div>
      </div>
  ...
  <div class="d-flex justify-content-between mt-3">
    <!-- Botón de regresar -->
    <a href="pg.php" class="btn btn-outline-primary">
      <i class="bi bi-arrow-left-circle"></i> Regresar
    </a>

    <!-- Botón de avanzar -->
    <a href="tg.php" class="btn btn-outline-success">
