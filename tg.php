...
<body>
  ...
  <div class="divider">
    <h2> <span style="color: brown;">Videos de tercer grado</span></h2>
  </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/L8couzPFTc4" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/Ff2uK7plF7A" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/3mn-K5aD1Do" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/mi9t5jpsDpM" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/UmaLkXBOLzE" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/VDp3EwhaCQo" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/YLvk_DzlXeU" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/7Jt9DZ2_ioc" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/s6dBkgYFcBU" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/LBVq6raJl-Y" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/KRyK79yP0oA" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div class="col-md-6 mb-4">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" width="100%" height="315" src="https://www.youtube.com/embed/_rzt1xCOy_o" allowfullscreen></iframe>
        </div>
      </div>
  ...
  <div class="d-flex justify-content-between mt-3">
    <!-- Botón de regresar -->
    <a href="sg.php" class="btn btn-outline-primary">
      <i class="bi bi-arrow-left-circle"></i> Regresar
    </a>

    <!-- Botón de avanzar -->
    <a href="cg.php" class="btn btn-outline-success">
